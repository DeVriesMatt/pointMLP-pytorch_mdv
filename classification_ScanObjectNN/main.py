...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=15,
        type=int,
        help="default value for classes of ScanObjectNN",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--learning_rate", default=0.01, type=float, help="learning rate in training"
    )
    parser.add_argument("--weight_decay", type=float, default=1e-4, help="decay rate")
    parser.add_argument(
        "--smoothing", action="store_true", default=False, help="loss smoothing"
    )
