...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--pmlp_folding_ckpt_path",
        default="/run/user/1128299809/gvfs/smb-share:server=rds.icr.ac.uk,share=data"
        "/DBI/DUDBI/DYNCESYS/mvries/ResultsAlma/pointMLP-pytorch/"
        "pointmlp_foldingTearingVersion_autoencoder_allparams.pt",
        type=str,
    )
    ...
    folding_data_new.to_csv(
        "/home/mvries/Documents/Datasets/OPM/SingleCellFromNathan_17122021/"
        "pointmlpfolding_50_nuc_all_centring.csv"
    )
    ...
    folding_data_new.to_csv(
        "/home/mvries/Documents/Datasets/OPM/SingleCellFromNathan_17122021/"
        "pointmlpfolding_50_cellandcnuc_all_centring.csv"
    )
